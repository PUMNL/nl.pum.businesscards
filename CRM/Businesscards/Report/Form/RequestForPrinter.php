...
class CRM_Businesscards_Report_Form_RequestForPrinter extends CRM_Report_Form {
  ...
  public function modifyColumnHeaders() {
    ...
    $this->_columnHeaders['03_vervalt'] = array('title' => '03_vervalt');
    $this->_columnHeaders['mobile'] = array('title' => '04_Contactgegevensveld (mobiel)');
    $this->_columnHeaders['email'] = array('title' => '05_Contactgegevensveld2 (email)');
    $this->_columnHeaders['skype'] = array('title' => '06_Contactgegevensveld3 (skype)');
    $this->_columnHeaders['twitter'] = array('title' => '07_Contactgegevensveld4 (twitter)');
    $this->_columnHeaders['08_Contactgegevensveld5'] = array('title' => '08_Contactgegevensveld5 (vrij)');
    $this->_columnHeaders['09_PrivateAddress'] = array('title' => '09_PrivateAddress');
    $this->_columnHeaders['address_street_address'] = array('title' => '10_Priveadres (adres)');
    $this->_columnHeaders['phone'] = array('title' => '11_Privecontactveld1(vaste tel.)');
  ...
  public function alterDisplay(&$rows) {
    foreach($rows as $index => $row) {
      ...
      if (!empty($row['address_country'])) {
        $rows[$index]['address_street_address'] .= $row['address_country'];
      }
